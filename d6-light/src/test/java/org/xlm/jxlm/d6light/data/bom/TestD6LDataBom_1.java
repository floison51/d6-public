...
/**
 * Test systemizer data : Part BOM ---- undirected links ---- Doc BOM
 * @author Francois Loison
 *
 */
public class TestD6LDataBom_1 extends D6LAbstractDataTestCase {

	public TestD6LDataBom_1() throws Exception {
		super();
	}

	static final public String TEST_CASE = "t01";
